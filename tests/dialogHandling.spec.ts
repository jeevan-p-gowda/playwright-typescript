...
test("Handling Alert Dialog in Playwright", async ({ page }) => {
...
test("Handling Confirm Dialog in Playwright", async ({ page }) => {
...
test("Handling Prompt Dialog in Playwright", async ({ page }) => {
